    ...
    if (this.state.fehler) {
      return (
        <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 p-8 text-center">
          ...
          <h2 className="text-lg font-semibold text-ink">Es ist ein Fehler aufgetreten</h2>
          ...
          <div className="flex gap-2 pt-1">
            <button
              onClick={this.reset}
              className="rounded-md border border-line-strong bg-panel px-4 py-2 text-sm font-medium text-ink hover:bg-panel-2"
            >
              Erneut versuchen
            </button>
            <button
