...
export const TRANSLATIONS = {
  de: {
    ...
    nichtAktiv:       'Bestellen per Handy ist an diesem Tisch gerade nicht möglich.',
    bestellenZahlen:  '💳 Bestellen & bezahlen',
    weiterZahlung:    'Weiter zur Bezahlung…',
    zahlungVerarbeitung: 'Zahlung wird verarbeitet…',
    zahlungAbgebrochen:  'Zahlung abgebrochen',
    zahlungAbgebrochenText: 'Es wurde nichts abgebucht. Du kannst es erneut versuchen.',
    zurueckZurKarte:  'Zurück zur Speisekarte',
    belegTitel:       'Bezahlt — vielen Dank!',
  ...
  en: {
    ...
    nichtAktiv:       'Ordering by phone is not available at this table right now.',
    bestellenZahlen:  '💳 Order & pay',
    weiterZahlung:    'Proceeding to payment…',
    zahlungVerarbeitung: 'Processing payment…',
    zahlungAbgebrochen:  'Payment cancelled',
    zahlungAbgebrochenText: 'Nothing was charged. You can try again.',
    zurueckZurKarte:  'Back to menu',
    belegTitel:       'Paid — thank you!',
  ...
  it: {
    ...
    nichtAktiv:       'Al momento non è possibile ordinare con lo smartphone a questo tavolo.',
    bestellenZahlen:  '💳 Ordina e paga',
    weiterZahlung:    'Reindirizzamento al pagamento…',
    zahlungVerarbeitung: 'Pagamento in corso…',
    zahlungAbgebrochen:  'Pagamento annullato',
    zahlungAbgebrochenText: 'Nessun addebito effettuato. Puoi riprovare.',
    zurueckZurKarte:  'Torna al menu',
    belegTitel:       'Pagato — grazie!',
