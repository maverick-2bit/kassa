/**
 * Countdown für die PIN-Bremse des Backends (Gegenstück zu frontend/src/lib/pin-sperre.ts).
 *
 * Nach zu vielen falschen PINs antwortet das Backend mit 429 + `wartenSekunden`
 * und prüft bis dahin gar keine PIN mehr. Das PIN-Feld zeigt das und bleibt so
 * lange gesperrt, statt bei jeder Eingabe dieselbe Meldung zu produzieren.
 */
