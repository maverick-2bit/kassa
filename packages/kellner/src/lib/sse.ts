/**
 * SSE-Anbindung an den Kassen-Event-Kanal (Muster identisch zum Haupt-POS).
 * Bisher hatte die Kellner-App KEINEN Empfangskanal — KDS-Nachrichten
 * („Schnitzel ist aus!") kamen nur an der Kassa an, nie am Handy.
 */
