...
**Backup lokal testen (ohne Cloud-Account):** `docker-compose.s3-test.yml` stellt
ein lokales S3 (SeaweedFS) als Ziel bereit; restic legt Bucket und Repository
...
```
Nur für Tests — das S3 läuft hier auf derselben Box und ist kein echtes Off-Site-Ziel.
